...
def get_identicon(email_address):
    ...
    fg_color_code = hash_code[3:6]
    point_code = hash_code[6]
    # In case background and foreground code are same, the following will avoid problems.
    if bg_color_code == fg_color_code:
        fg_color_code = hash_code[4:7]
        point_code = hash_code[3]
    bg_color = (int(bg_color_code[0]+'0',16)+8,int(bg_color_code[1]+'0',16)+8,int(bg_color_code[2]+'0',16)+8)
    fg_color = (int(fg_color_code[0]+'0',16)+8,int(fg_color_code[1]+'0',16)+8,int(fg_color_code[2]+'0',16)+8)
...
get_identicon(input('Enter an email address to recieve an identicon.  '))
